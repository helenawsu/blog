...
[chinese calligraphy dataset](https://www.kaggle.com/datasets/yuanhaowang486/chinese-calligraphy-styles-by-calligraphers/data). Each calligrapher has around 5k training imges and 1k testing images. The training parameters are the same as in the MNIST section, except the hidden dimension is increased to 256 and epoch 5. Training for 5 epochs takes approximately 2 minutes on an A100 GPU.
